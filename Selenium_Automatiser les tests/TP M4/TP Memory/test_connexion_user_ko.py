...
class TestTestconnexionmdpko():
  ...
  def test_testconnexionmdpko(self):
    ...
    WebDriverWait(self.driver, 10).until(expected_conditions.presence_of_element_located((By.XPATH, "/html/body/script")))
